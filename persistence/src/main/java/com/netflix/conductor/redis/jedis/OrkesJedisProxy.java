...
public class OrkesJedisProxy {
    ...
    // Use the actual smembers command - use if the set is smlal enough
    ...
    public String set(String key, byte[] value) {
        return jedisCommands.set(key.getBytes(StandardCharsets.UTF_8), value);
    }
    ...
    public byte[] getBytes(String key) {
        return jedisCommands.getBytes(key.getBytes(StandardCharsets.UTF_8));
    }
}
