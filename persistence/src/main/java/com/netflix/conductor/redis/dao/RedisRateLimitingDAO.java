...
public class RedisRateLimitingDAO extends BaseDynoDAO implements RateLimitingDAO {
     ...
     *       leveraging {@link OrkesJedisProxy#zremrangeByScore(String, String, String)}, this is
     *       done to make the next step of evaluation efficient
     ...
     *       {@link OrkesJedisProxy#zcount(String, double, double)}
