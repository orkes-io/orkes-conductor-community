 ...
 */
package io.orkes.conductor.execution.tasks.mapper;
 ...
 */
@Component
public class OrkesForkJoinDynamicTaskMapper implements TaskMapper {

    public static final Logger LOGGER =
            LoggerFactory.getLogger(OrkesForkJoinDynamicTaskMapper.class);
    ...
    @Autowired
    public OrkesForkJoinDynamicTaskMapper(
        ...
        LOGGER.info("OrkesForkJoinDynamicTaskMapper initialized");
    }
